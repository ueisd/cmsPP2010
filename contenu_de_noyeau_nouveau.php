...
<?php
if(isset($_GET['table_nouveau']))
{
$table_nouveau=$_GET['table_nouveau'];
}

$essai='noyau/Applications/' . $table_nouveau . '/nouveau.php';
include($essai);
?>

<a href="contenu_d_application_nouveau.php?table_nouveau=liste_d_articles">  plus ==></a>
