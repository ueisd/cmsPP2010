...
if(isset($_POST['modifier_mur_d_article']) AND $_POST['modifier_mur_d_article']!='' )
{ 
$mur_d_article_id=$_POST['modifier_mur_d_article'];

mysql_connect("$type_hote_base_de_donnee", "$Utilisateur_base_de_donnee", "$Code_base_de_donnee"); 
mysql_select_db("$Nom_base_de_donnee");
$reponse = mysql_query("SELECT * FROM mur_d_articles WHERE id='$mur_d_article_id'");
...
<tr><td>Titre du mur d'articles: </td><td> <input type="text" name="titre_du_mur_d_articles" value="<?php echo $donnees['titre_du_mur_d_articles']; ?>" /></td></tr>
<tr><td>Nom du mur d'articles dans la section administration: </td><td><input type="text" name="nom_du_mur_d_articles_administration" value="<?php echo $donnees['nom_du_mur_d_articles_administration']; ?>" /></td></tr>
<tr><td>Nombre d'articles par pages du mur: </td><td><input type="text" name="nombre_d_articles_par_pages" value="<?php echo $donnees['nombre_d_articles_par_pages']; ?>" /></td></tr>
...
$reponse_array_categorie_inclure = mysql_query("SELECT * FROM applications_J_inclure_categories WHERE id_application='$mur_d_article_id' AND nom_de_table_de_l_application='$table_de_l_application'");
...
$reponse_array_categorie_exclure = mysql_query("SELECT * FROM applications_J_exclure_categories WHERE id_application='$mur_d_article_id' AND nom_de_table_de_l_application='$table_de_l_application'");
...
<input type="hidden" name="modifier_mur_d_articles" value="<?php echo $mur_d_article_id; ?>" />
<input type="hidden" name="array_id_categories_des_articles" value="<?php echo implode("|",$array_id_categories_des_articles); ?>" />
<input type="submit" name="soumettre" value="Enregistrer la modification du mur d'articles" />
