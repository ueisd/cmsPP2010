...
$titre_photo=$_FILES['image_poste']['name'];
$personne=$_POST['nom_personne'];
$poste=$_POST['nom_poste'];
$type_poste=$_POST['galerie_type'];
mysql_connect("$type_hote_base_de_donnee", "$Utilisateur_base_de_donnee", "$Code_base_de_donnee"); 
mysql_select_db("$Nom_base_de_donnee");
mysql_query("INSERT INTO poste VALUES('', '$personne', '$poste', '$type_poste', '$titre_photo')");
if(isset($_FILES['image']) and $_FILES['image']['error'] == 0)
{
$reponse = mysql_query("SELECT id FROM poste WHERE adresse='$titre_photo'");
