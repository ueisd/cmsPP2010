...
$reponse_page2 = mysql_query("SELECT * FROM Conteneurs WHERE id='$id_du_bloc'");
while ($donnees_page = mysql_fetch_array($reponse_page2) )
{
?>

<div id="application_bloc_central">
<div id="titre">
...
mysql_connect("$type_hote_base_de_donnee", "$Utilisateur_base_de_donnee", "$Code_base_de_donnee"); 
mysql_select_db("$Nom_base_de_donnee"); 
$reponse2 = mysql_query("SELECT * FROM Applications_des_conteneurs WHERE id_du_conteneur='$id_du_bloc' ORDER BY ordre");
while ($donnees3 = mysql_fetch_array($reponse2) )
{
...
while ($donnees_application3 = mysql_fetch_array($reponse_application) )
{
$Nom_de_variable_id=$donnees_application3['Nom_de_variable_id'];
$Adresse_dans_include=$donnees_application3['Adresse_dans_include'];
...
<input type="hidden" name="type_conteneur" value="bloc_central" />
<input type="hidden" name="Modifier_page" value="<?php echo $id_du_bloc; ?>" />
<input type="submit" name="Mod_page000" value="Administrer le bloc central" />
</form>
</td>
</tr>
</table>
