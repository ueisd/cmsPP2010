...
include("Applications/articles/traitement/supprimer.php");

if(isset($_POST['articles_supprimer']) and ($_POST['articles_supprimer']=='supprimer'))
{ ?>
<a href="archives.php">Termin&#233;</a>
<?php }

/* traitement des nouveaux article */
include("Applications/articles/traitement/nouveau.php");
...
{
/* traitement des modifications des articles */
include("Applications/articles/traitement/modifier.php");
} 
?>
