...
<tr><td>Titre de la liste d'articles: </td><td> <input type="text" name="titre_de_la_liste_d_articles" /></td></tr>
<tr><td>Nom de la liste d'articles dans la section administration: </td><td><input type="text" name="nom_de_la_liste_d_articles_administration" /></td></tr>
...
<input type="hidden" name="nouvelle_liste_d_articles" value="ok" />
